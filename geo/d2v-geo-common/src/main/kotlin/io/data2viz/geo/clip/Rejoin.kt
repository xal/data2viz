...
//    val segments1 =   if(segments.size == 2) {
//        val mutableListOf = mutableListOf<List<DoubleArray>>()
//        mutableListOf.add(segments[0])
//        mutableListOf
//
//    } else {
//     segments
//
//    }
//    println("rejoin segments ${segments1.size} startInside = $startInside")
