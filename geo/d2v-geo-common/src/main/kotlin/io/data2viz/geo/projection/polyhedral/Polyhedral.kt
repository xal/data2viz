...
//
//
//class PolyhedralProjection(root: Any, face: Any, r: Any) {
//
//}
//
//fun recurse(node: Any, parent: Any): Any {
...
//}
//
//fun hasInverse(node: Any): Boolean {
////    return node.project.invert || node.children && node.children.some(hasInverse);
//}
//
//
//fun outline(stream: Stream, node: Any, parent: Any) {
////    var point,
////    edges = node.edges,
////    n = edges.length,
////    edge,
...
//fun pointEqual(a: Any, b: Any): Any {
////    return a && b && a[0] === b[0] && a[1] === b[1];
//}
//
////// Finds a shared edge given two clockwise polygons.
//fun sharedEdge(a: Any, b: Any):Any {
