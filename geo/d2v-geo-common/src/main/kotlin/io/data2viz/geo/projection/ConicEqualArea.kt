...
//fun conicEqualAreaRaw(phi0: Double, phi1: Double) {
//    var sy0 = sin(phi0)
//    var n = (sy0 + sin(phi1)) / 2;
//
//    // Are the parallels symmetrical around the Equator?
//    if (abs(n) < EPSILON) return cylindricalEqualProjector(phi0);
//
//    var c = 1 + sy0 * (2 * n - sy0), r0 = sqrt(c) / n;
//
//    function project (x, y) {
...
//import {cylindricalEqualProjector} from "./cylindricalEqualArea";
//
//export function conicEqualAreaRaw(phi0, phi1) {
//    var sy0 = sin(phi0), n = (sy0 + sin(phi1)) / 2;
//
//    // Are the parallels symmetrical around the Equator?
//    if (abs(n) < epsilon) return cylindricalEqualProjector(phi0);
//
